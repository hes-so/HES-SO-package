...
#let page-title-script(
  ...
  if option.lang == "en" {
    ...
    if authors.first().name != none {[*Authors*: #enumerating_emails(names:authors.map(a => a.name), emails:authors.map(a => a.email))\ ]}
    ...
    if authors.first().name != none {[*Autheurs*: #enumerating_emails(names:authors.map(a => a.name), emails:authors.map(a => a.email))\ ]}
    if date != none {[*Date*: #date\ ]}
    if version != none {[*Version*: #version]}
  } else if option.lang == "de" {
    ...
    if authors.first().name != none {[*Authoren*: #enumerating_emails(names:authors.map(a => a.name), emails:authors.map(a => a.email))\ ]}
